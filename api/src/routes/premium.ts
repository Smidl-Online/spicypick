...
premiumRoutes.post('/subscribe', authMiddleware, async (c) => {
  ...
  // If RevenueCat is configured, verify subscription status server-side.
  // The RevenueCat SDK on mobile handles receipt submission automatically;
  // we just check the subscriber's entitlement status via RC API.
